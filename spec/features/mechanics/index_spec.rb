...
RSpec.describe 'As a user,' do
  describe 'When I visit the mechanics index page' do
    ...
    it 'And I see a list of all mechanic’s names and their years of experience' do
      ...
      expect(page).to have_content(@jimmy.years_experience)
      expect(page).to have_content(@mike.years_experience)
      expect(page).to have_content(@molly.years_experience)
    end

    it 'And I see the average years of experience across all mechanics' do
      expect(page).to have_content("Average Years of Esperience: 4")
    end
  end
end
